...
const INSTALL_SCRIPT: InstallStep[] = [
  ...
  { text: "Hit:1 https://deb.pranavmshukla.in/pranavos stable InRelease", delay: 250, type: "info" },
  { text: "Get:2 https://deb.pranavmshukla.in/pranavos stable/main wasm-emulators [1,808 kB]", delay: 350, type: "info" },
  { text: "Get:3 https://deb.pranavmshukla.in/pranavos stable/main doom-wad-shareware [5,482 kB]", delay: 450, type: "info" },
