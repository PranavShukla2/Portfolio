...
const SHAPES: Record<PieceSymbol, React.ReactNode> = {
  ...
  n: (
    <path d="M25 6c5 0 9 5 9 11 0 5-1 9-1 13l1 7H14c0-7 2-12 6-16l-7 2c-2 .6-3.6-1.6-2.6-3.4L13 16l8-5 1-5z" />
  ),
  b: (
    <>
      ...
      {/* the mitre's slit, so it never reads as a pawn */}
      <path d="M19.4 22.5 26 15.4" fill="none" strokeLinecap="round" />
    </>
  ),
  q: (
