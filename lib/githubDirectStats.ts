...
const CACHE_KEY = "pranav_gh_contributions_v1";
...
const BASELINE: GitHubDirectStats = {
  totalContributions: "1,396",
  yearContributions: "1,375",
  currentStreak: 7,
  longestStreak: 21,
  loading: false,
  stale: true,
 ...
 * a spinner.
 */
export function useGitHubDirectStats(username: string = "PranavShukla2") {
